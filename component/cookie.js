    ...
    return (
        <section style={{
            ...
            <div style={{
                ...
                <button type='button' className='btn' onClick={() => setRight(false)}>NO!</button>
                <button type='button' className='btn' onClick={() => setRight(true)}>OK!</button>
            </div>
