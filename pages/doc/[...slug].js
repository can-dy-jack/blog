...
function DOCPages({ data_asider, data }) {
  ...
  let pre = null;
  let next = null;
  data_asider.data.forEach((asider) => {
    if (asider.type === 'dir') {
      ...
      <div className={styles.article_box}>
        <div className={styles.aside_show} ref={show_aside}>
          <svg width="24px" height="24px" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="var(--font)">
            <path d="M12 14a2 2 0 100-4 2 2 0 000 4z" stroke="var(--font)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M21 12c-1.889 2.991-5.282 6-9 6s-7.111-3.009-9-6c2.299-2.842 4.992-6 9-6s6.701 3.158 9 6z" stroke="var(--font)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
